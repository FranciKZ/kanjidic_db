...
CREATE TABLE IF NOT EXISTS kanji_db.additional_info (id INTEGER GENERATED ALWAYS AS IDENTITY, kanji_id INTEGER, grade INTEGER, stroke_count INTEGER, PRIMARY KEY(id), CONSTRAINT fk_kanji FOREIGN KEY(kanji_id) REFERENCES kanji_db.kanji(id));
